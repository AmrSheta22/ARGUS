...
import { useDeleteSummary } from "../../hooks.ts";
...
type SummaryFeatures = typeof features;

const columnHelper = createColumnHelper<SummaryFeatures, Summary>();
...
export function SummaryTable({
  ...
  const isPending = deleteSummary.isPending;
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.add({
        ...
        description: summaryToDelete.title,
        type: "success",
      });
  ...
  return (
    <>
      ...
      <Dialog open={!!summaryToDelete} onOpenChange={(open) => !open && setSummaryToDelete(null)}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Delete summary</DialogTitle>
            <DialogDescription>
              Are you sure you want to delete &ldquo;{summaryToDelete?.title}&rdquo;? This action
              cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button variant="outline" disabled={isPending} onClick={() => setSummaryToDelete(null)}>
              Cancel
            </Button>
